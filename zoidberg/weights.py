...
def modify_maps(maps, partial_boundaries = True):
    ...
    Ensures consistency of boundaries and forward/backward operators,
    depending on whether cells can partially intersect boundaries.
